...
object PolicyUtils {
   ...
   *
   * @param inputFile Input file RDD
   * @param portfolio Currently owned Portfolio
   * @param stockTickers List of stock tickers to choose from
   * @return Random ticker
   */
  def getNewRandomTicker(inputFile: RDD[((Date, String), (Double, Double))], portfolio: Portfolio, stockTickers: List[String]): String = {
  ...
  /**
   * This function handles the sell operation on stocks.
   *
   * @param inputFile  Input file RDD
   ...
   */
  def sellStock(inputFile: RDD[((Date, String), (Double, Double))], ticker: String, portfolio: Portfolio, day: Date): Double = {
   ...
   */
  def buyStock(inputFile: RDD[((Date, String), (Double, Double))], ticker: String, portfolio: Portfolio, day: Date, money: Double): Double = {
   ...
   */
  def stopLoss(inputFile: RDD[((Date, String), (Double, Double))], ticker: String, currentPosition: (Date, Double), day: Date, delta: Double): Boolean = {
   ...
   * @return Boolean representing whether this stock should be sold or not
   */
  def gainPlateaued(inputFile: RDD[((Date, String), (Double, Double))], ticker: String, currentPosition: (Date, Double), day: Date, delta: Double): Boolean = {
